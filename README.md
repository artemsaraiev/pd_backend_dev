...
- Project Framing [`PROJECT_FRAMING.md`](final_project_framing/PROJECT_FRAMING.md)
- Design: [`DESIGN_BACKEND.md`](DESIGN_BACKEND.md)
- Reflection: [`REFLECTION_BACKEND.md`](REFLECTION_BACKEND.md)
- Change log: [`changes_for_4c.md`](changes_for_4c.md)
